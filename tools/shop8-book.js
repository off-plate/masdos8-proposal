...
(()=>{
  ...
  function renderSheet(min){
    ...
    const fs=p.querySelector('#b-s'), fd=p.querySelector('#b-d'), ft=p.querySelector('#b-t'),
    ...
    const drawSum=()=>{
      sum.innerHTML=`
        ...
        <div class="bsum__r"><span>With</span><b>${SVC_WITH}</b></div>
    ...
    go.addEventListener('click',()=>{
      ...
      p.innerHTML=`<div class="bok"><div class="bok__i">&#10003;</div>
        ...
        <p class="tx" style="margin-inline:auto">${sel.n}, ${sel.d} at ${sel.t}, with ${SVC_WITH}. ${sel.p.toLocaleString('cs-CZ')} Kč, ${SVC_PAY.toLowerCase()}.</p>
